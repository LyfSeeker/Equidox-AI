    ...
    >
      <div className="h-16 flex items-center justify-between px-3 border-b border-crucible-border gap-2">
        ...
        <button
          ...
          className="btn btn-ghost btn-icon shrink-0 h-9 w-9"
      ...
      <div className="p-3 border-t border-crucible-border space-y-1">
        {!collapsed && (
